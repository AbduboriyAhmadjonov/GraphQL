...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    //     //  && this.props.userId !== data.post.creator
  ...
  loadPosts = (direction) => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then((resData) => {
        console.log('Posts fetched:', resData);
        if (resData.errors) {
  ...
  statusUpdateHandler = (event) => {
    ...
    fetch('http://localhost:8080/graphql', {
      ...
      .then((resData) => {
        ...
        // Access the string directly instead of a nested object
        this.setState({ status: resData.data.updateStatus });
      })
      .catch(this.catchError);
  };
  ...
  finishEditHandler = (postData) => {
    ...
    fetch('http://localhost:8080/post-image', {
      ...
      .then((fileResData) => {
        ...
        if (!imageUrl) {
          imageUrl = postData.image.toString();
        }
        let graphqlQuery = {
          query: `
            mutation CreatePost($title: String!, $content: String!, $imageUrl: String!) {
              createPost(
                ...
                _id title content creator { name } imageUrl createdAt
              }
            }
          `,
          variables: {
